...
void CBPlusTree::printData()const
{
    ...
    while(itr!=NULL)
    {
        ...
        {
            cout<<itr->getData(i).num<<":"<<itr->getData(i).name<<":"<<itr->getData(i).grade<<":"<<itr->getData(i).department<<":"<<itr->getData(i).mailbox<<" ";
        }
        cout<<endl;
...
bool CBPlusTree::update(KeyType oldKey, KeyType newKey)
{
    ...
    else
    {
        ...
        //TODO
        if (dataValue.num==INVALID_INDEX)
        {
            return false;
        }
        else
